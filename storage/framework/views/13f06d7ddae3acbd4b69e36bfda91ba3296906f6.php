<meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo e(asset('assets_admin/plugins/fullcalendar/fullcalendar.min.css')); ?>">
		...
		<!-- Main CSS -->
        <link rel="stylesheet" href="<?php echo e(asset('assets_admin/css/style.css')); ?>"><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rt/resources/views/layout/partials/head_admin.blade.php ENDPATH**/ ?>