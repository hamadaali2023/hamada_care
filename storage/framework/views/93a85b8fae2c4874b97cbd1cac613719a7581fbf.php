    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="nav-item <?php echo e(Request::is('/') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الرئيسية</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('categories') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/categories')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الخدمات</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('orders') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/orders')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الاوردرات</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('doctors') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/doctors')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">مقدمي الخدمات</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('patients') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/patients')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">متلقي الخدمات</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('roles') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/roles')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الصلاحيات</span></a>
        </li>
        <!-- <li class="nav-item <?php echo e(Request::is('/sliders') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/sliders')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">السلايدر</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('/pannars') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/pannars')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">البنرات</span></a>
        </li> -->
        <li class="nav-item <?php echo e(Request::is('countries') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/countries')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">البلاد</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('cities') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/cities')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المدينة</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('users') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/users')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الموظفين</span></a>
        </li>
        <li class="nav-item <?php echo e(Request::is('profile') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('/profile')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">حسابي</span></a>
        </li>

        <li   class="<?php echo e(Request::is('doctornotifaction') ? 'active' : ''); ?>"> 
            <a href="<?php echo e(url('doctornotifaction')); ?>"><i class="la la-envelope"></i> <span class="menu-title">ارسال اشعارات لدكتور</span></a>
        </li>

        <li   class="<?php echo e(Request::is('patientnotifaction') ? 'active' : ''); ?>"> 
            <a href="<?php echo e(url('patientnotifaction')); ?>"><i class="la la-envelope"></i> <span class="menu-title">ارسال اشعارات لمريض</span></a>
        </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-bolt"></i><span class="menu-title" data-i18n="nav.flot_charts.main">الإعدادات</span></a>
          <ul class="menu-content">
            <li  class="<?php echo e(Request::is('settings') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('settings')); ?>" data-i18n="nav.flot_charts.flot_line_charts">الاعدادات</a>
            </li>
            <!-- '<li  class="<?php echo e(Request::is('admin/about') ? 'active' : ''); ?>"> 
                            <a class="menu-item" href="<?php echo e(url('admin/about')); ?>" data-i18n="nav.flot_charts.flot_line_charts">من نحن</a>
                        </li>' -->
            <li  class="<?php echo e(Request::is('privacy') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('privacy')); ?>" data-i18n="nav.flot_charts.flot_bar_charts">سياسية الخصوصية</a>
            </li>
            <li  class="<?php echo e(Request::is('contact') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('contact')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">معلومات التواصل</a>
            </li>
            <!-- <li  class="<?php echo e(Request::is('terms') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('admin/terms')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">الشروط والتعليمات</a>
            </li>
            <li  class="<?php echo e(Request::is('agreements') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('admin/agreements')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية المؤلف</a>
            </li> -->
             <!-- <li  class="<?php echo e(Request::is('return_policy') ? 'active' : ''); ?>"> 
                <a class="menu-item" href="<?php echo e(url('admin/return_policy')); ?>" data-i18n="nav.flot_charts.flot_pie_charts">سياسة الإرجاع</a>
            </li> -->
          </ul>
        </li>
        <!--<li class="nav-item <?php echo e(Request::is('admin/sliders') ? 'active' : ''); ?>">-->
        <!--    <a href="<?php echo e(url('admin/sliders')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">اسلايدر</span></a>-->
        <!--</li>-->
        <!-- <li class="nav-item <?php echo e(Request::is('/all-books') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('admin/all-books')); ?>"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الكتب</span></a>
        </li> -->

        <!--  <li class="nav-item <?php echo e(Request::is('/reports') ? 'active' : ''); ?>">
            <a href="<?php echo e(url('admin/reports')); ?>">
                <i class="la la-envelope"></i><span class="menu-title" data-i18n="">التقارير</span>
            </a>
        </li>
 -->
  ...
  </div><?php /**PATH /home/beaunqrp/public_html/sub/care/resources/views/layout/admin_sidbar.blade.php ENDPATH**/ ?>