              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                   	<div class="card-body">
						<form action="<?php echo e(url('settings/update')); ?>" method="POST" name="le_form"  enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
							...
							<div class="row">
								...
								<!-- <div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="max_price" class="form-control" value="<?php echo e($contactInfo->max_price); ?>">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>اسعر الادنى</label>
										<input type="text" name="min_price" class="form-control" value="<?php echo e($contactInfo->min_price); ?>">
									</div>
								</div> -->
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea name="description_ar" id="ckeditor" cols="30" rows="15"  class="form-control ckeditor"><?php echo e($contactInfo->description_ar); ?></textarea>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										...
										<!-- <input type="text" name="privacy" class="form-control" value="<?php echo e($contactInfo->privacy); ?>"> -->
										<textarea name="description_en" id="ckeditor" cols="30" rows="15"  class="form-control ckeditor" ><?php echo e($contactInfo->description_en); ?></textarea>
									</div>	
								</div>
								<div class="col-md-12">									
									<div class="form-group">
...
<?php echo $__env->make('layout.admin_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/findfamily/public_html/care/resources/views/admin/settings/settings.blade.php ENDPATH**/ ?>