 <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="index.html">
              <!-- <img class="brand-logo" alt="modern admin logo" src="<?php echo e(asset('admin/images/logo/logo.png')); ?>"> -->
              <h3 class="brand-text">kutuphanah Admin</h3>
            </a>
          </li>
            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <span class="avatar avatar-online">
                  ...
                  <img src="<?php echo e(asset('admin/images/portrait/small/avatar-s-19.png')); ?>" alt="avatar"><i></i></span>
              </a>
      ...
      </div><?php /**PATH /home/beaunqrp/public_html/sub/care/resources/views/layout/admin_nav.blade.php ENDPATH**/ ?>