   ...
   public function addNewService(Request $request)
    ...
    public function walletWithdraw(Request $request)
    {
            ...
            if(isset($request->lang)  && $request -> lang == 'en' ){
                ...
                return $this -> returnSuccessMessage('تم ارسال طلب السحب');
            } 
    }
    ...
    public function getBalanceTransaction(Request $request)
    {
        ...
        $wallet_payment_total = Transaction::where('walletId',$doctor_wallet->id)
                                                        ->where('type','دفع')
                                                        ->sum('value');
        $alltransaction = Transaction::where('walletId',$doctor_wallet->id)
                                                        ->get();                                                
