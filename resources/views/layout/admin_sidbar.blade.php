    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="nav-item {{ Request::is('/') ? 'active' : '' }}">
            <a href="{{url('/')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الرئيسية</span></a>
        </li>
        <li class="nav-item {{ Request::is('categories') ? 'active' : '' }}">
            <a href="{{url('/categories')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الخدمات</span></a>
        </li>
        <li class="nav-item {{ Request::is('orders') ? 'active' : '' }}">
            <a href="{{url('/orders')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الاوردرات</span></a>
        </li>
        <li class="nav-item {{ Request::is('doctors') ? 'active' : '' }}">
            <a href="{{url('/doctors')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">مقدمي الخدمات</span></a>
        </li>
        <li class="nav-item {{ Request::is('patients') ? 'active' : '' }}">
            <a href="{{url('/patients')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">متلقي الخدمات</span></a>
        </li>
        <li class="nav-item {{ Request::is('roles') ? 'active' : '' }}">
            <a href="{{url('/roles')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الصلاحيات</span></a>
        </li>
        <!-- <li class="nav-item {{ Request::is('/sliders') ? 'active' : '' }}">
            <a href="{{url('/sliders')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">السلايدر</span></a>
        </li>
        <li class="nav-item {{ Request::is('/pannars') ? 'active' : '' }}">
            <a href="{{url('/pannars')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">البنرات</span></a>
        </li> -->
        <li class="nav-item {{ Request::is('countries') ? 'active' : '' }}">
            <a href="{{url('/countries')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">البلاد</span></a>
        </li>
        <li class="nav-item {{ Request::is('cities') ? 'active' : '' }}">
            <a href="{{url('/cities')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">المدينة</span></a>
        </li>
        <li class="nav-item {{ Request::is('users') ? 'active' : '' }}">
            <a href="{{url('/users')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الموظفين</span></a>
        </li>
        <li class="nav-item {{ Request::is('profile') ? 'active' : '' }}">
            <a href="{{url('/profile')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">حسابي</span></a>
        </li>

        <li   class="{{ Request::is('doctornotifaction') ? 'active' : '' }}"> 
            <a href="{{url('doctornotifaction')}}"><i class="la la-envelope"></i> <span class="menu-title">ارسال اشعارات لدكتور</span></a>
        </li>

        <li   class="{{ Request::is('patientnotifaction') ? 'active' : '' }}"> 
            <a href="{{url('patientnotifaction')}}"><i class="la la-envelope"></i> <span class="menu-title">ارسال اشعارات لمريض</span></a>
        </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-bolt"></i><span class="menu-title" data-i18n="nav.flot_charts.main">الإعدادات</span></a>
          <ul class="menu-content">
            <li  class="{{ Request::is('settings') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{ url('settings') }}" data-i18n="nav.flot_charts.flot_line_charts">الاعدادات</a>
            </li>
            ...
            <li  class="{{ Request::is('privacy') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('privacy')}}" data-i18n="nav.flot_charts.flot_bar_charts">سياسية الخصوصية</a>
            </li>
            <li  class="{{ Request::is('contact') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('contact')}}" data-i18n="nav.flot_charts.flot_pie_charts">معلومات التواصل</a>
            </li>
            ...
            <li  class="{{ Request::is('agreements') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/agreements')}}" data-i18n="nav.flot_charts.flot_pie_charts">إتفاقية المؤلف</a>
            </li> -->
             <!-- <li  class="{{ Request::is('return_policy') ? 'active' : '' }}"> 
        ...
        <!--</li>-->
        <!-- <li class="nav-item {{ Request::is('/all-books') ? 'active' : '' }}">
            <a href="{{url('admin/all-books')}}"><i class="la la-envelope"></i><span class="menu-title" data-i18n="">الكتب</span></a>
        </li> -->
