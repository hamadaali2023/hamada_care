		                    ...
		                    <table class="table table-striped table-bordered keytable-integration">
											...
											@foreach ($categories as $_item)
												<tr>													
													...
													<td class="text-center">
														<img class="avatar-img" src="{{asset('assets_admin/img/categories/'.$_item->image) }}" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
													...
													<td class="text-center">
														<div class="actions">
															...
															<a class="btn btn-sm bg-success-light" href="{{ url('categories/'.$_item->id).'/edit' }}"><i class="fe fe-pencil"></i> تعديل</a>
