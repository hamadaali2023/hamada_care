		...
		<div class="content-header row">
			        ...
			        <div class="content-header-right col-md-6 col-12">
			          <div class="dropdown float-md-right">
			               <a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-primary float-right mt-2">إضافة خدمة فرعية</a>
			          </div>
			        </div>
                    ...
                    <div class="card-body">
						<div class="table-responsive">
		                    <table class="table table-striped table-bordered keytable-integration">
											...
											@foreach ($subcategories as $_item)
												<tr>													
													<td class="text-center">
														<img class="avatar-img" src="{{asset('assets_admin/img/subcategory/'.$_item->icon) }}" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
														<img class="avatar-img" src="{{asset('assets_admin/img/subcategory/'.$_item->image) }}" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
													...
													<td class="text-center">
														<div class="actions">
															...
															<a class="btn btn-sm bg-success-light" href="{{ url('subcategories/'.$_item->id).'/edit' }}"><i class="fe fe-pencil"></i> تعديل</a>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">إضافة الخدمة</h5>
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="title_en" class="form-control" value="{{old('title_ar')}}">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>حدد الخدمة الرئيسي </label>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							 ...
							 <form  method="post" action="{{route('subcategories.update','test')}}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('subcategories.destroy','test')}}">
	                                   		 @csrf
	                                         @method('delete')
	                                         <input type="hidden" name="id" id="cat_id" >
